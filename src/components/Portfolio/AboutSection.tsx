  ...
  return (
    <section className="section-container bg-section-bg">
      <div className="container mx-auto">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          {highlights.map((highlight, index) => {
            ...
            return (
              <div 
                key={index}
                className="glass-card text-center group animate-scale-in hover-lift"
        ...
        <div className="mt-20 glass-card p-10 lg:p-16 animate-slide-up" style={{animationDelay: "0.8s"}}>
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-8">
              ...
              <div className="space-y-4">
                {[
                  { text: "Enhanced backend reliability by ~25%", delay: "1s" },
                  { text: "Improved SQL query performance by ~15%", delay: "1.2s" },
            ...
            <div>
              ...
              <div className="grid grid-cols-2 gap-4">
                {["Collaboration", "Leadership", "Problem-solving", "Attention to detail"].map((skill, index) => (
                  <div 
                    key={index} 
                    className="skill-tag justify-center py-3 hover:bg-gradient-to-r hover:from-primary/10 hover:to-accent/10 animate-scale-in"
